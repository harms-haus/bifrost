...
export const Popover = {
  ...
  Popup: tailwind(
    BasePopover.Popup,
    "bg-[var(--bg-secondary)] border border-[var(--border)] p-4 shadow-lg origin-[var(--transform-origin)] transition-[transform,opacity] data-[starting-style]:scale-90 data-[starting-style]:opacity-0 data-[ending-style]:scale-90 data-[ending-style]:opacity-0",
  ),
  ...
  Close: tailwind(
    BasePopover.Close,
    "mt-3 inline-flex items-center justify-center px-3 py-1.5 text-sm font-medium cursor-pointer transition-colors bg-[var(--bg-tertiary)] border border-[var(--border)] text-[var(--text-primary)] hover:bg-[var(--border)]",
  ),
