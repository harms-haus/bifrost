...
export const AlertDialog = {
  ...
  Trigger: tailwind(
    ...
    "inline-flex items-center justify-center px-4 py-2 text-sm font-medium rounded-md cursor-pointer transition-colors bg-[var(--danger)] text-white hover:opacity-90 focus:outline-2 focus:outline-[var(--accent)] focus:outline-offset-2",
  ),
